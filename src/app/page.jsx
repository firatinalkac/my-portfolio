...
export default function Home() {
  return (
    <div className="h-full flex flex-col lg:flex-row  p-4 sm:p-8 md:p-12 lg:p-20 xlg:p-28">
      {/* IMAGE CONTAINER */}
      ...
      <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 justify-center">
        ...
        <p className="md:text-xl">
          ...
          doloribus odio fugiat, reiciendis sapiente ducimus ipsam pariatur
          possimus maxime temporibus ad. Debitis possimus voluptas nobis soluta,
          sunt inventore optio!
        </p>
        {/* BUTTONS */}
